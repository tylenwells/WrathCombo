        ...
        internal new static unsafe void Draw()
        {
            ...
            if (ImGui.CollapsingHeader("IPC"))
            {
                ...
                if (_wrathLease is not null)
                {
                    ...
                    {
                        // https://github.com/ffxivcode/AutoDuty/blob/master/AutoDuty/IPC/IPCSubscriber.cs#L536
                        P.IPC.SetCurrentJobAutoRotationReady(_wrathLease!.Value);
                        ...
                        P.IPC.SetAutoRotationConfigState(_wrathLease!.Value,
                            AutoRotationConfigOption.IncludeNPCs, true);
                        P.IPC.SetAutoRotationConfigState(_wrathLease!.Value,
                            AutoRotationConfigOption.OnlyAttackInCombat, false);
                        P.IPC.SetAutoRotationConfigState(_wrathLease!.Value,
